            ...
            <div className="col-8 merriweather weight300 h2 black fontSizeSmall">
              ...
              <div className="container-fluid ml-3">
                <p className="lineHeightDouble size12">
                  ...
                  returns results with the PageRank Algorithm. Uses a web
                  crawler to add files linked in other files. Created with C++
                  for a class project.
                </p>
              </div>
            </div>
          ...
          <div className="row m-md-2 ">
            <div className="col-8 merriweather weight300 h2 black fontSizeSmall">
              <p className="lineHeightDouble">
                If you would like to see some of the art I've created, click
